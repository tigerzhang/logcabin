...
Result
ClientImpl::pub(const std::string& path,
                 const std::string& workingDirectory,
                 const std::string& contents,
                 const Condition& condition,
                 TimePoint timeout)
...
Result
ClientImpl::lpush(const std::string& path,
             const std::string& workingDirectory,
             const std::string& contents,
             const Condition& condition,
             TimePoint timeout)
...
Result
ClientImpl::ltrim(const std::string& path,
                 const std::string& workingDirectory,
                 const std::string& contents,
                 const Condition& condition,
                 TimePoint timeout)
...
Result
ClientImpl::smembers(const std::string& path,
                   const std::string& workingDirectory,
                   const Condition& condition,
                   TimePoint timeout,
